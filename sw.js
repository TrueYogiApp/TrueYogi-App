...
const AUDIO_ASSETS = [
  ...
  'https://assets.trueyogi.app/assets/music8.m4a',  
  ...
  'https://assets.trueyogi.app/assets/music/music-en.mp3',
  'https://assets.trueyogi.app/assets/music/music-te.mp3',
  'https://assets.trueyogi.app/assets/music/music-fr.mp3',
  'https://assets.trueyogi.app/assets/music/music-es.mp3',
  'https://assets.trueyogi.app/assets/music/music-de.mp3',
  'https://assets.trueyogi.app/assets/music/music-hi.mp3',
  'https://assets.trueyogi.app/assets/music/music-zh.mp3',
  'https://assets.trueyogi.app/assets/music/music-it.mp3',
  'https://assets.trueyogi.app/assets/music/music-ru.mp3',
  'https://assets.trueyogi.app/assets/music/music-ja.mp3',
  'https://assets.trueyogi.app/assets/music/music-pt.mp3',
  'https://assets.trueyogi.app/assets/music/music-ar.mp3',    
  'https://assets.trueyogi.app/assets/Spaceship.ultraraygun.mp3',  
  'https://assets.trueyogi.app/assets/Spaceship-takeoff.wav',   
  'https://assets.trueyogi.app/assets/Spaceship-heal.wav',  
  'https://assets.trueyogi.app/assets/deep.space.mp3',
  'https://assets.trueyogi.app/assets/ultimate.stillness.mp3',
...
const APP_FILES = [
  ...
  '/assets/welcomeMessages.zh.json',
  '/assets/welcomeMessages.ru.json',
  '/assets/welcomeMessages.it.json',  
  '/assets/welcomeMessages.ja.json',
  '/assets/welcomeMessages.pt.json',
  '/assets/welcomeMessages.ar.json',   
  '/locales/en.json',
  '/locales/te.json',
  '/locales/fr.json',  
  '/locales/hi.json',
  ...
  '/assets/quotes.zh.json',
  '/assets/quotes.ru.json',
  '/assets/quotes.it.json',  
  '/assets/quotes.ja.json',
  '/assets/quotes.pt.json',
  '/assets/quotes.ar.json',    
  ...
  '/assets/wisdom.ja.json',
  '/assets/wisdom.pt.json',
  '/assets/wisdom.ar.json',  
  ...
  '/assets/sacred.lines.ja.json', 
  '/assets/sacred.lines.pt.json', 
  '/assets/sacred.lines.ar.json'     
];
